  ...
  return (
    <Popover
      ...
      trigger={
        <button
          type="button"
          className="flex h-9 items-center gap-2 rounded-none bg-kern-surface-2 px-3 text-sm text-kern-text-2 transition-colors hover:bg-kern-surface hover:text-kern-text"
        >
          <Columns2 size={14} />
          <span>Fields</span>
        </button>
